...
<html lang="pt-br">
    ...
    <body>
        <div class="cAlign">
            ...
            <div id="header">
                <div id="logo">
                    <img src="../imagens/conteudos/baner.png" width="500" height="100">
                </div>
                    ...
                    <div id="mainContent">
                        ...
                        <div class="mainBox">
                            <div class="mainBoxTitle">
                                <h2 class="mainBoxHeader">Animes</h2>
                            </div>
                            <div id="capas_2">
                                <ul>
                                <?php
                                   $nome = $_GET['nome'];
                                    $capa = mysqli_query($estacia, "SELECT * FROM capa WHERE nome='$nome'");
                                    $contacapa = mysqli_num_rows($capa);
                                    $linha = mysqli_fetch_array($capa);
                                    
                                    echo '<img class="capad" src="../imagens/conteudos/capa/'.$linha['img'].'" style:"height:350px; 
    width:150px;"> '                        
                                            . '<label><b>Nome: </b>'.$linha['nome'].'<br><hr></label>'
                                            . '<label><b>Genero:</b> ' .$cod = utf8_encode($linha['genero']).'<br><hr></label>'
                                            . '<label><b>Formato:</b> ' .$linha['formato'].'<br><hr></label>'
                                            . '<label><b>Autor:</b> ' .$linha['autor'].'<br><hr></label>'
                                ?>
                                    
                                    <di id="sinopse">
                                        <br>
                                        <?php
                                         echo "<p>".utf8_encode($linha['descricao'])."</p>";
                                        ?>
                                    </di>    
                                </ul>
                        ...
                        <div class="mainBox">
                            <div class="mainBoxTitle">
                                <h2 class="mainBoxHeader">Episodios</h2>
                            </div>
                            <div>
                                <ul>
                                <?php
                                    $conteudo = mysqli_query($estacia, "SELECT * FROM conteudo WHERE nome='$nome'"
                                            . "ORDER BY idconteudo desc");
                                    
                                    $conta = mysqli_num_rows($conteudo);
                                    if ($conta > 0) {
                                        while ($ln = mysqli_fetch_array($conteudo)) {
                                            echo '<li class="mainList">  
                                                    <div class="videoThumb" style="height:100px;">
                                                        <a href="assitir.php?id='.$ln['idconteudo'].'">
